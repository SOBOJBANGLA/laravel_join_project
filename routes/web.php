...
Route::get('/', function () {
    ...
    //     Route::post('user_register', [RegisterController::class, 'store']);

    //     Route::get('front_login', [RegisterController::class, 'login'])->name('user_login_form');
    ...
    Route::group(['middleware' => ['auth'], 'prefix' => 'user', 'as' => 'user.'], function () {
        ...
        Route::middleware('userCheck')->group(function () {
            Route::middleware('kyc')->group(function () {
                ...
                // fund transfer
                Route::get('fund/transfer', 'User\HomeController@fund_transfer')->name('transfer.fund');
                Route::post('fund/transfer/save', 'User\HomeController@fund_transfer_save')->name('fund.transfer.save');
