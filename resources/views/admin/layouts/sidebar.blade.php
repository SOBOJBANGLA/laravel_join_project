        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                @if(adminAccessRoute(config('role.user_management.access.view')))
                    ...
                    <li class="sidebar-item ">
                        <a class="sidebar-link" href="{{ url('admin/agent/users') }}" aria-expanded="false">
                            <i class="fas fa-users text-success"></i>
                            <span class="hide-menu">@lang('Agent User')</span>
                        </a>
                    </li>

                    <li class="sidebar-item ">
                        <a class="sidebar-link" href="{{ route('admin.agent.fund') }}" aria-expanded="false">
                            <i class="fas fa-users text-success"></i>
                            <span class="hide-menu">@lang('Agent Fund')</span>
                        </a>
                    </li>
