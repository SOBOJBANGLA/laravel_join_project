...
<link rel="shortcut icon" href="{{asset('assets/themes/betting/images/SeraBajiLogo.png')}}" type="image/x-icon">
{{--<!-- Apple Stuff -->--}}
<link rel="apple-touch-icon" href="{{asset('assets/themes/betting/images/SeraBajiLogo.png')}}">
<title>@lang($basic->site_title) | @yield('title')</title>
<link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets/themes/betting/images/SeraBajiLogo.png')}}">
