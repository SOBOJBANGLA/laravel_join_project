                ...
                @foreach($data as $games)
                    <div class="col-md-4">
                        <div class="card" style="width: 100%">
                            <img class="card-img-top" src="https://www.shutterstock.com/image-photo/photo-chic-fancy-lady-professional-600nw-2377355339.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">{{$games['ename']}}</h5>
                                <a href="{{route('dmd.all.sports.open',$games['eid'])}}" target="_blank" class="btn btn-primary">Play</a>
                            </div>
                        </div>
                    </div>
                @endforeach
