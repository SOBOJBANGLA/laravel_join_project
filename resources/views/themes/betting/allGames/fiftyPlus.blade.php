                ...
                @foreach($games as $games)
                    <div class="col-md-4">
                        <div class="card" style="width: 100%">
                            ...
                            @else
                                <img class="card-img-top"
                                     src="https://img.freepik.com/premium-photo/sexy-casino-croupier-elegant-female-dealer-work_1234908-13155.jpg"
                                     alt="Card image cap">
                            @endif

                            <div class="card-body">
                                <h5 class="card-title">{{$games->game_name}}</h5>
                                <a href="{{route('casino.evo.game.open',$games->game_uuid)}}" target="_blank"
