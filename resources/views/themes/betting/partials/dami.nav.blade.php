    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                {{--                        <li><a class="dropdown-item {{menuActive('about')}}"--}}
                {{--                               href="{{route('about')}}">@lang('About')</a></li>--}}
                {{--                        <li><a class="dropdown-item {{menuActive('faq')}}" href="{{route('faq')}}">@lang('FAQ')</a></li>--}}
                {{--                        <li><a class="dropdown-item {{menuActive('blog')}}" href="{{route('blog')}}">@lang('Blog')</a>--}}
                {{--                        </li>--}}
                {{--                        <li><a class="dropdown-item {{menuActive('contact')}}"--}}
